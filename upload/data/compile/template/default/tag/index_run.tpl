...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb">
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag'; ?>">话题</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag'; ?>">热门话题</a>
		</div>
		<div class="tag_page_run cc">
			<div class="tag_nav">
				<ul class="cc">
					<li class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag'; ?>">热门话题</a></li>
					<li><a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=my'; ?>" data-referer="true" class="J_qlogin_trigger">我关注的话题</a></li>
				</ul>
			</div>
			<!--新话题列表-->
			<div class="mb20">
				<div id="j2D5YnZv" class="design_layout_style J_mod_layout box_no" role="structure_j2D5YnZv" data-lcm="100">			
  ...
  <?php }?>
			...
			<div class="box_wrap tag_hotlist">
				...
				?>
					<dl class="cc">
						<dt>
							<div class="title"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=view&name=', rawurlencode($v['tag_name']); ?>"><?php echo htmlspecialchars($v['tag_name'], ENT_QUOTES, 'UTF-8');?></a></div>
							...
							<a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=attention&type=del&id=', rawurlencode($v['tag_id']); ?>" data-type="unfollow" data-id="<?php echo htmlspecialchars($v['tag_id'], ENT_QUOTES, 'UTF-8');?>" class="core_unfollow J_follow_btn J_qlogin_trigger">取消关注</a>
							<?php } else {?>
							<a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=attention&type=add&id=', rawurlencode($v['tag_id']); ?>" data-type="follow" data-id="<?php echo htmlspecialchars($v['tag_id'], ENT_QUOTES, 'UTF-8');?>" class="core_follow J_follow_btn J_qlogin_trigger">关注该话题</a>
							<?php }?>
							</div>
							<?php }?>
						</dt>
						...
						?>
							<a class="J_user_card_show" data-uid="<?php echo htmlspecialchars($uv, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=space&uid=', rawurlencode($uv); ?>"><img class="J_avatar" src="<?php echo htmlspecialchars(Pw::getAvatar($uv, 'small'), ENT_QUOTES, 'UTF-8');?>" data-type="small" width="40" height="40" alt="" /></a>
						<?php  } ?>
						</dd>
					</dl>
				<?php  } ?>
...
Wind.use('jquery', 'global', function(){
	//关注&取消关注
	var URL_ADD = '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=attention&type=add'; ?>',
		URL_DEL = '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=attention&type=del'; ?>';
