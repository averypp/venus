...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb" id="bread_crumb">
			<?php echo $headguide;
  if ($tab == 'digest') { ?><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid),'&tab=digest'; ?>">精华</a><?php  } 
  if ($type) { ?><em>&gt;</em>
				<?php  $_urladd_ = $tab ? '&tab=' . $tab : ''; 
  if ($_parentid = $topictypes['all_types'][$type]['parentid']) { ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid),'&type=', rawurlencode($_parentid); 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');?>"><?php echo $topictypes['all_types'][$_parentid]['name'];?></a><em>&gt;</em>
				<?php  } ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid),'&type=', rawurlencode($type); 
	...
	<div class="forum_info_box cc" id="J_forum_info_box">
		...
		<div class="name">
			<?php  if ($loginUser->isExists() && $pwforum->foruminfo['type'] != 'category') { ?>
				...
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=forum&a=join&fid=', rawurlencode($fid); ?>" data-role="join" data-fid="<?php echo htmlspecialchars($fid, ENT_QUOTES, 'UTF-8');?>" class="core_follow J_forum_join J_qlogin_trigger">加入版块</a>
				<?php  } else { ?>
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=forum&a=quit&fid=', rawurlencode($fid); ?>" data-role="quit" data-fid="<?php echo htmlspecialchars($fid, ENT_QUOTES, 'UTF-8');?>" class="core_unfollow J_forum_join">已加入<span>&nbsp;&nbsp;|&nbsp;&nbsp;取消</span></a>
				<?php  } ?>
				</span>
			<?php  } ?>
 ...
 echo htmlspecialchars($key ? '，' : '', ENT_QUOTES, 'UTF-8');?><a class="J_user_card_show" data-username="<?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=space&username=', rawurlencode($value); ?>"><?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?></a><?php  } ?>
		</div>
		<?php  } ?>
		<div class="notice">
 ...
 PwHook::segment("forum_list_table", array($pwforum->foruminfo,$sub), "one_across", "", $__viewer); 
	...
	<?php  } ?>
					...
					<div class="pages_wrap cc">
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=post&fid=', rawurlencode($pwforum->fid); ?>" class="btn_post J_thread_post_btn<?php echo htmlspecialchars($postNeedLogin, ENT_QUOTES, 'UTF-8');?>" data-rel="J_thread_post_types_1">发帖</a>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid),'&page=', rawurlencode($_page_i); 
...
<?php } ?>
					...
					<div class="box_wrap thread_page J_check_wrap">
						<nav>
							<div class="content_nav">
								...
								?>
								<div class="content_filter"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid); 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');
 echo htmlspecialchars($defaultOrderby == 'lastpost' ? '&orderby=postdate' : '', ENT_QUOTES, 'UTF-8');?>" class="<?php echo htmlspecialchars(Pw::isCurrent($orderby == 'postdate'), ENT_QUOTES, 'UTF-8');?>">最新发帖</a><span>|</span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid); 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');
 echo htmlspecialchars($defaultOrderby == 'lastpost' ? '' : '&orderby=lastpost', ENT_QUOTES, 'UTF-8');?>" class="<?php echo htmlspecialchars(Pw::isCurrent($orderby != 'postdate'), ENT_QUOTES, 'UTF-8');?>">最后回复</a></div>
								<ul class="cc" id="hashpos_ttype">
									<li class="<?php echo htmlspecialchars(Pw::isCurrent(!$tab), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid); ?>">全部</a></li>
									<li class="<?php echo htmlspecialchars(Pw::isCurrent('digest' == $tab), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($fid),'&tab=digest'; ?>">精华</a></li>
									<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=user&fid=', rawurlencode($fid); ?>">会员</a></li>
								</ul>
							</div>
							...
							<div class="content_type">
								<ul class="cc">
									<li class="<?php echo htmlspecialchars(Pw::isCurrent(!$type), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($pwforum->fid); 
										...
										<div class="fl J_menu_drop_list"  style="margin-top:22px;display:none;">
											<div class="core_menu">
												<ul class="core_menu_list cc">
													...
													<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($pwforum->fid),'&type=', rawurlencode($v2['id']); 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars(strip_tags($v2['name']), ENT_QUOTES, 'UTF-8');?>"><?php echo $v2['name'];?></a></li>
										...
										<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($pwforum->fid),'&type=', rawurlencode($v['id']); 
...
<tr>
  ...
  if ($_parentid = $topictypes['all_types'][$value['topic_type']]['parentid']) { ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($pwforum->fid),'&type=', rawurlencode($_parentid); ?>" class="st">[<?php echo $topictypes['all_types'][$_parentid]['name'];?>]</a>
				<?php  } ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($pwforum->fid),'&type=', rawurlencode($value['topic_type']); ?>" class="st">[<?php echo $topictypes['all_types'][$value['topic_type']]['name'];?>]</a>
			<?php  } ?>
...
<?php  $tpc_topped = isset($value['issort']); 
  ...
  if ($operateThread['topped']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=manage&a=topped'; ?>">置顶</a><?php  } 
  ...
  if ($operateThread['ban']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=manage&a=ban'; ?>">禁止</a><?php  } ?>
							</div>
							<?php  } 
  } else { ?>
					...
					<div class="pages_wrap cc">
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=post&fid=', rawurlencode($pwforum->fid); ?>" class="btn_post J_thread_post_btn<?php echo htmlspecialchars($postNeedLogin, ENT_QUOTES, 'UTF-8');?>" data-rel="J_thread_post_types_2">发帖</a>
						<div class="J_page_wrap" data-key="true">
<?php $__tplPageCount=(int)$count;
$__tplPagePer=(int)$perpage;
$__tplPageTotal=(int)$totalpage;
...
<?php  if ($operateThread){ ?>
  ...
  if ($operateThread['type']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=manage&a=type'; ?>">分类</a></li><?php  } ?>
							<!-- <li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=manage&a=topped'; ?>">印戳</a></li>  -->
							<?php  if ($operateThread['move']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=manage&a=move'; ?>">移动</a></li><?php  } 
  ...
  if ($operateThread['ban']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=manage&a=ban'; ?>">禁止</a></li><?php  } ?>
						</ul>
					</div>
				</div>
			</div>
...
<?php  } 
  if ($loginUser->isExists()) { ?>
	var JOIN_URL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=forum&a=join'; ?>",		//版块加入
			QUIT_URL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=forum&a=quit'; ?>",		//版块退出
			lock = false;
