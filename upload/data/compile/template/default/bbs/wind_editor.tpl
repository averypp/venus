<textarea name="atc_content" id="J_wind_editor" style="height:300px;width:100%;padding:0;margin:0;"><?php echo htmlspecialchars($atc_content, ENT_QUOTES, 'UTF-8');?></textarea>
<script>
	/*
